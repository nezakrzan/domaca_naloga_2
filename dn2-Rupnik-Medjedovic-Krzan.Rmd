...
risi_razlicna_var <- function(theta_zacetek, sigma){
  ...
  ggarrange(g1, g2, align = "hv",
            labels = c("Prvih 5000 clenov zaporedja", 
                       "Celotno zaporedje"),
            font.label = list(size = 10),
            ncol = 2)
}
...
```{r sigma 0.3, echo=FALSE, fig.align='center', fig.height=4, fig.width=10, message=FALSE, warning=FALSE}
risi_razlicna_var(1.95, 0.3)
```

### $\sigma = 0.2$

```{r sigma 0.2, echo=FALSE, fig.align='center', fig.height=4, fig.width=10, message=FALSE, warning=FALSE}
risi_razlicna_var(1.95, 0.2)
```

### $\sigma = 0.06$

```{r sigma 0.06, echo=FALSE, fig.align='center', fig.height=4, fig.width=10, message=FALSE, warning=FALSE}
risi_razlicna_var(1.95, 0.06)
```

### $\sigma = 0.03$

```{r sigma 0.03, echo=FALSE, fig.align='center', fig.height=4, fig.width=10, message=FALSE, warning=FALSE}
risi_razlicna_var(1.95, 0.03)
```
